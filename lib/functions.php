...
//$pass = md5($pass);
	...
	$SQL = "SELECT COUNT(*) AS C FROM gym.usuarios WHERE nombre='".mysql_real_escape_string($user)."' AND clave='".mysql_real_escape_string($pass)."' AND estado='A'";
	//echo $SQL;
        //exit;
...
function getPersonas($descrip){
	...
	$SQL="SELECT * FROM  gym.personas WHERE CONCAT(nombre,' ',apellido) LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPersonasUsuarios($descrip){
	...
	$SQL="SELECT p.*, u.id_usuario FROM  gym.personas p "
...
function getAreas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.areas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getTipoEquipo($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.tipo_equipo WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getLugares($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.lugar WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getProveedores($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.proveedor WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getMarcas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.marcas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getAplicaciones($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.aplicativos WHERE nombre_menu LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPoes($descrip){
	...
	$SQL="SELECT pc.* FROM  gym.poe_cabecera pc "
                . " LEFT JOIN gym.examen e ON e.id_poe=pc.id_poe"
...
function getExamenes($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  gym.examen WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
