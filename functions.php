...
//$pass = md5($pass);
	...
	$SQL = "SELECT COUNT(*) AS C FROM usuarios WHERE nombre='".mysql_real_escape_string($user)."' AND clave='".mysql_real_escape_string($pass)."' AND estado='A'";
	//echo $SQL;
        //exit;
...
function getPersonas($descrip){
	...
	$SQL="SELECT * FROM  personas WHERE CONCAT(nombre,' ',apellido) LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPersonasUsuarios($descrip){
	...
	$SQL="SELECT p.*, u.id_usuario FROM  personas p "
...
function getAreas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  areas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getTipoEquipo($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  tipo_equipo WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getLugares($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  lugar WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getProveedores($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  proveedor WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getMarcas($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  marcas WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getAplicaciones($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  aplicativos WHERE nombre_menu LIKE '%".$descrip."%'";
        //echo $SQL;
...
function getPoes($descrip){
	...
	$SQL="SELECT pc.* FROM  poe_cabecera pc "
                . " LEFT JOIN examen e ON e.id_poe=pc.id_poe"
...
function getExamenes($descrip){
	global $conn;
	 ...
	 $SQL="SELECT * FROM  examen WHERE descripcion LIKE '%".$descrip."%'";
        //echo $SQL;
